...
class MainApp(ctk.CTk):
    ...
    def add_message(self, text, sender="user"):
        print(f"Малюю повідомлення: {text} від {sender}")
    ...
    def setup_message_bar(self):
        ...
        self.message_entry = ctk.CTkEntry(
            self.msg_bar, placeholder_text="Message", font=self.assets.Body,   
    ...
    def open_file_explorer(self):
        ...
        if filepath:
            ...
            self.message_entry.delete(0, "end")
            self.message_entry.insert(0, f"File: {filename}")
    ...
    def _listen_process(self):
        try:
            self.after(0, lambda: self.message_entry.configure(placeholder_text="Listening..."))
            ...
            self.after(0, lambda: self.message_entry.configure(placeholder_text="Message..."))
